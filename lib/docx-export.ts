...
import { Document, Paragraph, TextRun, HeadingLevel, IParagraphOptions, NumberFormat, Packer, AlignmentType } from 'docx';
...
function createParagraph(text: string, options: Partial<IParagraphOptions> = {}): Paragraph {
        ...
        case 'h1':
          currentSection.children.push(
            createParagraph(text, {
              ...
              spacing: { before: 240, after: 120, line: 240, lineRule: 'exact' },
        ...
        case 'h2':
          currentSection.children.push(
            createParagraph(text, {
              ...
              spacing: { before: 200, after: 60, line: 240, lineRule: 'exact' },
              children: [{ 
                bold: true, 
                size: 28, // 14pt
                font: 'Calibri',
        ...
        case 'h3':
          currentSection.children.push(
            createParagraph(text, {
              ...
              spacing: { before: 160, after: 40, line: 240, lineRule: 'exact' },
              children: [{ 
                bold: true, 
                size: 26, // 13pt
                font: 'Calibri',
...
export async function exportToWord(htmlContent: string): Promise<void> {
  ...
  try {
    ...
    throw new Error(error instanceof Error ? error.message : 'Failed to export Word document');
  }
}